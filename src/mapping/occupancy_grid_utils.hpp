...
*/
inline Point<double> grid_position_to_global_position(const Point<double>& gridPosition, const OccupancyGrid& grid)
{
...
*/
inline Point<int> global_position_to_grid_cell(const Point<double>& globalPosition, const OccupancyGrid& grid)
{
...
*/
inline Point<double> global_position_to_grid_position(const Point<double>& globalPosition, const OccupancyGrid& grid)
{
